...
\section{Source Code, GitHub Repository, and Project Resources}

The complete source code, final report PDF, diagrams, and relevant resources of the \textbf{Automated Car Parking System} have been organized for documentation and submission purposes.

\textbf{GitHub Repository Link:} \\
\url{https://github.com/Mamim57/Automated-Car-Parking-System}

\textbf{Project Resources and Demonstration Video Link:} \\
\url{https://drive.google.com/drive/folders/1aT3PHK54hXkYco_JdObG85XIEDzsyu1J?usp=drive_link}

The GitHub repository contains the source code, report files, diagrams, and related documentation. The Google Drive folder contains the project demonstration video and supporting resources. The demonstration video was provided through Google Drive because large video files are not always suitable for direct GitHub upload.
